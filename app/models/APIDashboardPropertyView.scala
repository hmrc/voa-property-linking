...
case class APIDashboardPropertyView(
...
object APIDashboardPropertyView {
  ...
  implicit val format: Format[APIDashboardPropertyView] =  Json.format[APIDashboardPropertyView]
}
