...
package uk.gov.hmrc.voapropertylinking.connectors.test
...
class TestConnector @Inject()(
  ...
  def deleteCheckCases(propertyLinkingSubmissionId: String)(
        implicit request: RequestWithPrincipal[_]): Future[HttpResponse] = {
    implicit val hc = HeaderCarrierConverter
