...
class ExternalValuationManagementApiISpec extends BaseIntegrationSpec with ExternalValuationManagementStub {
  ...
  trait TestSetup {
    ...
    lazy val connector: ExternalValuationManagementApi = app.injector.instanceOf[ExternalValuationManagementApi]
  }
