...
import uk.gov.hmrc.voapropertylinking.stubs.modernised.ModernisedCustomerManagementStub
import utils.FakeObjects

import java.time.Instant
import scala.concurrent.ExecutionContext

class ModernisedCustomerManagementApiIndividualsISpec
  extends BaseIntegrationSpec with ModernisedCustomerManagementStub with FakeObjects {

  trait TestSetup {
    lazy val connector: ModernisedCustomerManagementApi = app.injector.instanceOf[ModernisedCustomerManagementApi]
