...
class ModernisedExternalOrganisationManagementISpec extends BaseIntegrationSpec with ModernisedExternalOrganisationManagementStub {
  ...
  trait TestSetup {
    ...
    lazy val connector: ModernisedExternalOrganisationManagementApi = app.injector.instanceOf[ModernisedExternalOrganisationManagementApi]
  }
