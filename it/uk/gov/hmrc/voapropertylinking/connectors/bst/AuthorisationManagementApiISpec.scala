...
import uk.gov.hmrc.voapropertylinking.stubs.bst.AuthorisationManagementStub

import scala.concurrent.ExecutionContext

class AuthorisationManagementApiISpec extends BaseIntegrationSpec with AuthorisationManagementStub {

  trait TestSetup {
    lazy val connector: AuthorisationManagementApi = app.injector.instanceOf[AuthorisationManagementApi]
