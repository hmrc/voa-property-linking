...
Ensure that you have the latest versions of the required uk.gov.hmrc.voapropertylinking.services and that they are running. This can be done via service manager using the BUSINESS_RATES_ALL profile
```
