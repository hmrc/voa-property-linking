...
class ModernisedAuthorisationManagementApiSpec extends BaseUnitSpec {

  val http: DefaultHttpClient = mock[DefaultHttpClient]
  val connector: ModernisedAuthorisationManagementApi = new ModernisedAuthorisationManagementApi(
    http,
    mockServicesConfig,
